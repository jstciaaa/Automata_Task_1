document.getElementById("checkButton").addEventListener("click", function() {
    ...
    if (scientificPattern.test(userInput)) {
        document.getElementById("result").innerText = userInput + " is a Scientific Number";
    } else {
        document.getElementById("result").innerText = userInput + " is not a Scientific Number";
    }
});
